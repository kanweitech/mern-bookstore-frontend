  ...
  return (
    <div className='h-[calc(100vh - 120px)] flex justify-center items-center'>
        <div className='w-full max-w-sm px-8 pt-6 pb-8 mx-auto mb-4 bg-white rounded shadow-md'>
            ...
            <p className='mt-4 text-sm font-medium align-baseline'>Already have an account? Please <Link to="/login" className="text-blue-500 hover:text-blue-700">Login</Link>
            </p>
